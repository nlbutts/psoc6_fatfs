...
#
CY_EXAMPLE_NAME = USBCommDevice

#
# Description of the example project to display
#
CY_EXAMPLE_DESCRIPTION = This code example demonstrates USB CDC interface class \
operation by implementing virtual COM that continually sends message Hello USB UART
...
#
CY_VALID_DEVICES = $(CY_DEVICES_WITH_FS_USB)
...
CY_MAINAPP_CM0P_SWCOMP_USED = \
	$(CY_PSOC_LIB_COMP_MIDDLEWARE_BASE)/usb_dev
...
CYCONFIG_GENERATED_SOURCES = \
	...
	GeneratedSource/cycfg_usbdev.h
